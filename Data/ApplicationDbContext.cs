    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Produit>().HasData(
                new Produit { Id = 1, Nom = "Huile Syntec 5W-30", Description = "Huile synthétique haute performance pour moteurs essence", Prix = 39.99m, CategorieProduitId = 3, QuantiteStock = 50, EstDisponible = true, ImageUrl = "/images/products/huile-syntec.jpeg", EnStock = true, EstPopulaire = true },
                new Produit { Id = 2, Nom = "Jeu d'essuie-glaces universel", Description = "Essuie-glaces de qualité supérieure adaptables à la plupart des véhicules", Prix = 24.99m, CategorieProduitId = 1, QuantiteStock = 30, EstDisponible = true, ImageUrl = "/images/products/essuie-glaces.jpeg", EnStock = true },
                new Produit { Id = 3, Nom = "Filtre à air K&N", Description = "Filtre à air haute performance lavable et réutilisable", Prix = 49.99m, CategorieProduitId = 5, QuantiteStock = 15, EstDisponible = true, ImageUrl = "/images/products/filtre-air.jpeg", EnStock = true, EstPopulaire = true },
                new Produit { Id = 4, Nom = "Batterie Exide 12V", Description = "Batterie fiable pour véhicules de tourisme standard", Prix = 89.99m, CategorieProduitId = 6, QuantiteStock = 10, EstDisponible = true, ImageUrl = "/images/products/batterie.jpeg", EnStock = true }
            );

            // Sample services
            modelBuilder.Entity<Service>().HasData(
                new Service { Id = 1, Nom = "Vidange complète", Description = "Vidange d'huile avec remplacement du filtre à huile", PrixEstimatif = 69.99m, CategorieServiceId = 2, ImageUrl = "/images/services/oil-change.jpeg" },
                new Service { Id = 2, Nom = "Montage et équilibrage de pneus", Description = "Montage, équilibrage et permutation de vos pneus", PrixEstimatif = 49.99m, CategorieServiceId = 4, ImageUrl = "/images/services/tire-mounting.jpeg" },
                ...
                new Service { Id = 4, Nom = "Recharge de climatisation", Description = "Contrôle et recharge du circuit de climatisation", PrixEstimatif = 79.99m, CategorieServiceId = 5, ImageUrl = "/images/services/ac-service.jpeg" }
            );
